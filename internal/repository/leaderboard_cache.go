...
type LeaderboardCache interface {
	IncrementScore(context.Context, int, string, int) error
...
func (c *redisLeaderboardCache) IncrementScore(ctx context.Context, gameID int, playerID string, delta int) error {
	if delta == 0 {
		return nil
	}
